...
def generate_sequence(length=10, related_group_size=2, vocab=None, include_seq_tokens=False):
    ...
    while len(sequence) < length:
        ...
        # Check to ensure related words are in the corpus
    ...
    # Add sequence tokens if necessary
    if include_seq_tokens:
...
def collate_fn(data):
    ...
    try:
        ...
        for item in data:
            ...
            # Pad sequences and targets within the item to the max length
            ...
            # Collect padded sequences, their lengths, and padded targets for the batch
